...
const showReceipe = async function () {
  /*Loading a recipe*/
  // fetch function returns a promise thus in async
  try {
    const id = window.location.hash.slice(1);
    // get id of recipe to be displayed on click
    if (!id) return;
  ...
  <div class="recipe__directions">
    ...
    // before inserting new markup remove the markup already existing
...
},{"regenerator-runtime":"62Qib","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["7BONy","3miIZ"], "3miIZ", "parcelRequire2b57")
